...
public class Feature {
    ...
    public String nom_feature;
    public int id_user_respensability;
    //public int priority;
    public int total_estimation_feature_jours;
    public int statue;
    public int id_theme;

    public Feature(int id_feature, String nom_feature, int id_user_respensability, int total_estimation_feature_jours, int statue, int id_theme) {
    ...
    public String toString() {
        return "Feature{" + "id_feature=" + id_feature + ", nom_feature=" + nom_feature + ", id_user_respensability=" + id_user_respensability + ", total_estimation_feature_jours=" + total_estimation_feature_jours + ", statue=" + statue + ", id_theme=" + id_theme + '}';
    }
